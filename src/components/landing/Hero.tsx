        ...
        <div className="flex items-center gap-8 lg:gap-12">
          ...
          <div className="hidden flex-shrink-0 lg:block">
            <div className="relative">
              ...
              <img src={heroPhoto} alt="Engenheiro Civil - Andrade Missão Engenharia" className="relative z-10 h-[480px] w-[380px] rounded-2xl object-cover object-top shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)]" />
